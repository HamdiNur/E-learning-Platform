                    ...
                    <form action="#" method="POST">
                        <div class="space-y-5">
                            ...
                            <div class="text-center">
                                <p class="text-base text-black">I dont have an account! <a href="#" title="" class="font-medium text-[#00796B]  transition-all duration-200 hover:text-[#00796B] hover:underline">Sign Up</a></p>
                            </div>
                        </div>
                    </form>
                </div>
